...
SkyBox::SkyBox(Shader* shader)
{
    ...
    faces.emplace_back("../skybox/right.jpg");
    faces.emplace_back("../skybox/left.jpg");
    faces.emplace_back("../skybox/top.jpg");
    faces.emplace_back("../skybox/bottom.jpg");
    faces.emplace_back("../skybox/front.jpg");
    faces.emplace_back("../skybox/back.jpg");
...
void SkyBox::drawSkybox() {
    ...
    this->shader->send("viewMatrix",viewMat);
    this->shader->send("projectionMatrix",projectionMat);
